                  ...
                  <tr>
                    ...
                    <td width="597" class="texto" align="left"><span id="spryselect1">
                      ...
                      <select name="selRel" class="textfield1" id="selRel"  onchange="selecionaRelatorio(this.value)">>
                        ...
                        <option value="RelCustos" <?php if ($acao == 'RelCustos') {echo 'selected="selected"';}?>>Relat&oacute;rio de Custos</option>
...
<?php
	...
	echo '      <select name="edConvenio" class="textfield1" id="edConvenio">';
                    ...
                    while ($Localiza = mssql_fetch_row($result))
                    {
                        echo '  <option value="'.utf8_encode($Localiza[0]).'"';
                        echo '>'.utf8_encode($Localiza[1]).'</option>';
                    }
        echo '      </select>';
        echo '          </td>';
        echo '  </tr>';	
...
/*        echo '          <label for="selConv" class="texto">Conv&ecirc;nio:</label>';
  ...
  if (isset($acao) && $acao == "RelPacGeap")
  {
	...
	echo '                    <option value="Recife">Recife</option>';
	echo '                    <option value="Aracaju">Aracaju</option>';
	echo '                    <option value="Fortaleza">Fortaleza</option>';
        echo '                </select>';
        echo '     </td>';
        echo '     <td width="100"><div align="left">';
        echo '                <label for="edPaciente" class="texto">Paciente</label>';
...
function GeraRelatorio(click)
{
        ...
        if (document.frmCadastro.selRel.value == 'RelEquipForn')
            window.open("Relatorios/rel_equip_prestador.php?DataInicial="+document.frmCadastro.edtDataInicial.value+"&DataFinal="+document.frmCadastro.edtDataFinal.value+"&Paciente="+document.frmCadastro.edPaciente.value+"&Fornecedor="+document.frmCadastro.edFornecedor.value+"&Equip="+document.frmCadastro.edEquip.value+"&Area="+document.frmCadastro.selArea.value+"&Convenio="+document.frmCadastro.edConvenio.value,"Atendimento","left=50,top=50,width=1080,height=600,toolbar=no,location=no,status=no,menubar=no,scrollbars=yes");
	...
	if (document.frmCadastro.selRel.value == 'RelCustos'){
		
		if (document.frmCadastro.edConvenio.value =='999'){document.frmCadastro.edConvenio.value ='';}
            window.open("Relatorios/rel_custos.php?DataInicial="+document.frmCadastro.edtDataInicial.value+"&DataFinal="+document.frmCadastro.edtDataFinal.value+"&Paciente="+document.frmCadastro.edPaciente.value+"&Convenio="+document.frmCadastro.edConvenio.value+"&Area="+document.frmCadastro.selArea.value,"Atendimento","left=50,top=50,width=1080,height=600,toolbar=no,location=no,status=no,menubar=no,scrollbars=yes");
