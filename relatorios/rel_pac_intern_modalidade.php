...
<table width="1063" border="0">
  <tr>
    ...
    <td width="424" class:= "titulo"><h3 align="center">Relat&oacute;rio de Pacientes internados por modalidade<br/><br /></h3></td>
...
<?php
	  ...
	  $result = mssql_query("PROC_RELATORIO_EQUIPFORN'$DataInicial', '$DataFinal','$Plano','$Area'",$con);
