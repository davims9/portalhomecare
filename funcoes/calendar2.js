/**
************************************************************************************************************************
Sistema: INTRANET - STP
Desenvolvimento:  João Daniel e Joel Tadeu
Última Alteração: 7/06/2004
Componente: calendar2.js
Resumo: Componente JavaScript para criação de um calendário (Formato Americano)
************************************************************************************************************************
**/
...
function cal_prs_date2 (str_date) {
	...
	var dt_numdays = new Date(arr_date[0], arr_date[0], 0);
