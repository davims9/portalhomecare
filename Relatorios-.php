                  ...
                  <tr>
                    ...
                    <td width="597" class="texto" align="left"><span id="spryselect1">
                      ...
                      <select name="selRel" class="textfield1" id="selRel"  onchange="selecionaRelatorio(this.value)">>
                        ...
                        <option value="RelVigi" <?php if ($acao == 'RelVigi') {echo 'selected="selected"';}?>>Relat&oacute;rio para Vigil&aacute;ncia Sanit&aacute;ria</option>
 ...
 <!--                   option value="RelAgendaPeriodo" <?php if ($acao == 'RelAgendaPeriodo') {echo 'selected="selected"';}?>>Agenda de Profissionais</option> -->
    ...
    <table width="687" height="20" border="0">
      <tr>
        <td width="80">&nbsp;</td>
        <?php
        if (isset($acao) && ($acao != "RelPacEmp"  && $acao != 'RelVigi')) 
        {
        ...
        ?> 
        <td width="321" ><input type="button" name="button" id="button" value="Gerar Relat&oacute;rio"  onclick="GeraRelatorio()"/></td>
      </tr>
</table>
<?php  
	...
	if (isset($acao) && $acao == "RelValMod") 
    {
        ...
        echo '                <label for="edConvenio" class="texto">Convъnio</label>';		
        ...
        echo '                    <option value="Nуo">Nуo</option>';
        echo '                </select>';		
        echo '            </td>';
        echo '          </tr>';
        echo '        </table>';
	...
	if (isset($acao) && $acao == "RelVigi") 
    {
        ...
        echo '                <label for="edMes" class="texto">Mes</label>';		
    ...
    if (isset($acao) && $acao == "RelGlosa") 
    {
        ...
        echo '          <tr>';
        echo '      </select>';
        echo '                <label for="selModalidade" class="texto">Da</label>';		
		echo '                <select name="selModalidade" class="textfield1" id="selModalidade">>';
        echo '                    <option value="NS">Nota de servi&ccedil;o</option>';
        echo '                    <option value="NG">Recimento pela Glosa</option>';
        echo '                </select>';		
        echo '            </td>';
        echo '          </tr>';
        echo '        </table>';
...
function GeraRelatorio()
{
		...
		if (document.frmCadastro.selRel.value != 'RelPacEmp' && document.frmCadastro.selRel.value != 'RelVigi')
		{
		...
		{	 	
		  if (document.frmCadastro.selRel.value == 'RelVigi')
			  window.open("Relatorios/rel_vigilancia.php?Mes="+document.frmCadastro.edMes.value+"&Ano="+document.frmCadastro.edAno.value,"Atendimento","left=50,top=50,width=810,height=600,toolbar=no,location=no,status=no,menubar=no,scrollbars=yes");
		  ...
		  if (document.frmCadastro.selRel.value == 'RelGlosa')
			  window.open("Relatorios/rel_glosa.php?&Modalidade="+document.frmCadastro.selModalidade.value+"&DataInicial="+document.frmCadastro.edtDataInicial.value+"&DataFinal="+document.frmCadastro.edtDataFinal.value,"Atendimento","left=50,top=50,width=810,height=600,toolbar=no,location=no,status=no,menubar=no,scrollbars=yes");
		 ...
		 if (document.frmCadastro.selRel.value == 'RelLucMod')
			  window.open("Relatorios/rel_lucro_modalidade.php?Convenio="+document.frmCadastro.edConvenio.value+"&Modalidade="+document.frmCadastro.selModalidade.value+"&DataInicial="+document.frmCadastro.edtDataInicial.value+"&DataFinal="+document.frmCadastro.edtDataFinal.value,"Atendimento","left=50,top=50,width=810,height=600,toolbar=no,location=no,status=no,menubar=no,scrollbars=yes");
